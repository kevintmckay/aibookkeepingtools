export default {
  async fetch(request, env, ctx) {
    ...
    // Strip any pre-existing permissive CORS
    h.delete("access-control-allow-origin");
    h.delete("access-control-allow-methods");
    h.delete("access-control-allow-headers");

    // Keep your security headers (can be kept in _headers too)
    ...
    // Optional: debug flag so we can confirm the worker is active
    h.set("X-Debug-Worker", "on");
